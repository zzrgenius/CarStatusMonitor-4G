...
#define UG96_OPTION_CHECK_CPIN /* uncomment this line to activate CPIN check */
...
atcustom_modem_context_t UG96_ctxt;

/* Private variables ---------------------------------------------------------*/
/* Array to convert AT+QIOPEN service type parameter to a string
*  need to be aligned with ATCustom_UG96_QIOPENservicetype_t
*/
static const AT_CHAR_t *const ug96_array_QIOPEN_service_type[] = { ((uint8_t *)"TCP"), ((uint8_t *)"UDP"), ((uint8_t *)"TCP LISTENER"), ((uint8_t *)"UDP_LISTENER"), }; /* all const */

/* --- VARIABLE SHARED TO SET BG96 SPECIFIC COMMANDS   */
static at_bool_t ug96_boot_synchro = AT_FALSE;
static at_bool_t ug96_change_ipr_baud_rate = AT_FALSE;
static at_bool_t ug96_QICGSP_config_command = AT_TRUE; /* Indicates if the write command is a config or a query cmd */
static at_bool_t ug96_sim_card_ready = AT_FALSE; /* expected boot sequence for actual UG96 firmware is
                                                  * +QUSIM: 1
                                                  * +CFUN: 1
                                                  * +CPIN: READY
                                                  * +QIND: SMS DONE
                                                  * +QIND: PB DONE
                                                  *
                                                  * To avoid problems, we consider that SIM is ready when the last one
                                                  * has been received (PB DONE)
                                                  */

/* --- VARIABLES SHARED IN THIS FILE   */
static ATCustom_UG96_QCFG_function_t UG96_QCFG_command_param;
static ATCustom_UG96_QCFG_function_t UG96_QCFG_received_param_name;
static ATCustom_UG96_QCFG_function_t UG96_QCFG_received_param_value;
/* memorize if waiting for QIOPEN */
static at_bool_t ug96_waiting_qiopen = AT_FALSE;
static uint8_t ug96_current_qiopen_socket_connected = 0U;

/* check if request PDN to activate is already active (QIACT) */
#if (USE_SOCKETS_TYPE == USE_SOCKETS_MODEM)
static at_bool_t ug96_pdn_already_active;
#endif /* USE_SOCKETS_TYPE */
/* memorize infos received in the URC +QIURC:"dnsgip" */
static ug96_qiurc_dnsgip_t ug96_qiurc_dnsgip;
...
static at_status_t fCmdBuild_ATD_UG96(atparser_context_t *p_atp_ctxt, atcustom_modem_context_t *p_modem_ctxt);
static at_status_t fCmdBuild_CGSN_UG96(atparser_context_t *p_atp_ctxt, atcustom_modem_context_t *p_modem_ctxt);
static at_status_t fCmdBuild_QPOWD_UG96(atparser_context_t *p_atp_ctxt, atcustom_modem_context_t *p_modem_ctxt);
static at_status_t fCmdBuild_QCFG_UG96(atparser_context_t *p_atp_ctxt, atcustom_modem_context_t *p_modem_ctxt);
static at_status_t fCmdBuild_QIACT_UG96(atparser_context_t *p_atp_ctxt, atcustom_modem_context_t *p_modem_ctxt);
static at_status_t fCmdBuild_QICSGP_UG96(atparser_context_t *p_atp_ctxt, atcustom_modem_context_t *p_modem_ctxt);
static at_status_t fCmdBuild_QPING_UG96(atparser_context_t *p_atp_ctxt, atcustom_modem_context_t *p_modem_ctxt);

static at_status_t fCmdBuild_QIOPEN_UG96(atparser_context_t *p_atp_ctxt, atcustom_modem_context_t *p_modem_ctxt);
static at_status_t fCmdBuild_QICLOSE_UG96(atparser_context_t *p_atp_ctxt, atcustom_modem_context_t *p_modem_ctxt);
static at_status_t fCmdBuild_QISEND_UG96(atparser_context_t *p_atp_ctxt, atcustom_modem_context_t *p_modem_ctxt);
static at_status_t fCmdBuild_QISEND_WRITE_DATA_UG96(atparser_context_t *p_atp_ctxt, atcustom_modem_context_t *p_modem_ctxt);
static at_status_t fCmdBuild_QIRD_UG96(atparser_context_t *p_atp_ctxt, atcustom_modem_context_t *p_modem_ctxt);
static at_status_t fCmdBuild_QISTATE_UG96(atparser_context_t *p_atp_ctxt, atcustom_modem_context_t *p_modem_ctxt);
static at_status_t fCmdBuild_QIDNSCFG_UG96(atparser_context_t *p_atp_ctxt, atcustom_modem_context_t *p_modem_ctxt);
static at_status_t fCmdBuild_QIDNSGIP_UG96(atparser_context_t *p_atp_ctxt, atcustom_modem_context_t *p_modem_ctxt);

/* UG96 specific analyze commands */
static at_action_rsp_t fRspAnalyze_CPIN_UG96(at_context_t *p_at_ctxt, atcustom_modem_context_t *p_modem_ctxt,
                                             IPC_RxMessage_t *p_msg_in, at_element_info_t *element_infos);
static at_action_rsp_t fRspAnalyze_CFUN_UG96(at_context_t *p_at_ctxt, atcustom_modem_context_t *p_modem_ctxt,
                                             IPC_RxMessage_t *p_msg_in, at_element_info_t *element_infos);
static at_action_rsp_t fRspAnalyze_QUSIM_UG96(at_context_t *p_at_ctxt, atcustom_modem_context_t *p_modem_ctxt,
                                              IPC_RxMessage_t *p_msg_in, at_element_info_t *element_infos);
static at_action_rsp_t fRspAnalyze_QIND_UG96(at_context_t *p_at_ctxt, atcustom_modem_context_t *p_modem_ctxt,
                                             IPC_RxMessage_t *p_msg_in, at_element_info_t *element_infos);
static at_action_rsp_t fRspAnalyze_QCFG_UG96(at_context_t *p_at_ctxt, atcustom_modem_context_t *p_modem_ctxt,
                                             IPC_RxMessage_t *p_msg_in, at_element_info_t *element_infos);
static at_action_rsp_t fRspAnalyze_QIACT_UG96(at_context_t *p_at_ctxt, atcustom_modem_context_t *p_modem_ctxt,
                                              IPC_RxMessage_t *p_msg_in, at_element_info_t *element_infos);


static at_action_rsp_t fRspAnalyze_QIOPEN_UG96(at_context_t *p_at_ctxt, atcustom_modem_context_t *p_modem_ctxt,
                                               IPC_RxMessage_t *p_msg_in, at_element_info_t *element_infos);
static at_action_rsp_t fRspAnalyze_QIURC_UG96(at_context_t *p_at_ctxt, atcustom_modem_context_t *p_modem_ctxt,
                                              IPC_RxMessage_t *p_msg_in, at_element_info_t *element_infos);
static at_action_rsp_t fRspAnalyze_QIRD_UG96(at_context_t *p_at_ctxt, atcustom_modem_context_t *p_modem_ctxt,
                                             IPC_RxMessage_t *p_msg_in, at_element_info_t *element_infos);
static at_action_rsp_t fRspAnalyze_QIRD_data_UG96(at_context_t *p_at_ctxt, atcustom_modem_context_t *p_modem_ctxt,
                                                  IPC_RxMessage_t *p_msg_in, at_element_info_t *element_infos);
static at_action_rsp_t fRspAnalyze_QISTATE_UG96(at_context_t *p_at_ctxt, atcustom_modem_context_t *p_modem_ctxt,
                                                IPC_RxMessage_t *p_msg_in, at_element_info_t *element_infos);
static at_action_rsp_t fRspAnalyze_QPING_UG96(at_context_t *p_at_ctxt, atcustom_modem_context_t *p_modem_ctxt,
                                              IPC_RxMessage_t *p_msg_in, at_element_info_t *element_infos);
static at_action_rsp_t fRspAnalyze_Error_UG96(at_context_t *p_at_ctxt, atcustom_modem_context_t *p_modem_ctxt,
                                              IPC_RxMessage_t *p_msg_in, at_element_info_t *element_infos);
/* Commands Look-up table */
const atcustom_LUT_t ATCMD_UG96_LUT[] =
{
  /* cmd enum - cmd string - cmd timeout (in ms) - build cmd ftion - analyze cmd ftion */
  {_AT,             "",             UG96_AT_TIMEOUT,       fCmdBuild_NoParams,   fRspAnalyze_None},
  {_AT_OK,          "OK",           UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_None},
  {_AT_CONNECT,     "CONNECT",      UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_None},
  {_AT_RING,        "RING",         UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_None},
  {_AT_NO_CARRIER,  "NO CARRIER",   UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_None},
  {_AT_ERROR,       "ERROR",        UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_Error_UG96},
  {_AT_NO_DIALTONE, "NO DIALTONE",  UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_None},
  {_AT_BUSY,        "BUSY",         UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_None},
  {_AT_NO_ANSWER,   "NO ANSWER",    UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_None},
  {_AT_CME_ERROR,   "+CME ERROR",   UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_Error_UG96},
  {_AT_CMS_ERROR,   "+CMS ERROR",   UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_CmsErr},

  /* GENERIC MODEM commands */
  {_AT_CGMI,        "+CGMI",        UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_CGMI},
  {_AT_CGMM,        "+CGMM",        UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_CGMM},
  {_AT_CGMR,        "+CGMR",        UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_CGMR},
  {_AT_CGSN,        "+CGSN",        UG96_DEFAULT_TIMEOUT,  fCmdBuild_CGSN_UG96,  fRspAnalyze_CGSN},
  {_AT_GSN,         "+GSN",         UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_GSN},
  {_AT_CIMI,        "+CIMI",        UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_CIMI},
  {_AT_CEER,        "+CEER",        UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_CEER},
  {_AT_CMEE,        "+CMEE",        UG96_DEFAULT_TIMEOUT,  fCmdBuild_CMEE,       fRspAnalyze_None},
  {_AT_CPIN,        "+CPIN",        UG96_DEFAULT_TIMEOUT,  fCmdBuild_CPIN,       fRspAnalyze_CPIN_UG96},
  {_AT_CFUN,        "+CFUN",        UG96_DEFAULT_TIMEOUT,  fCmdBuild_CFUN,       fRspAnalyze_CFUN_UG96},
  {_AT_COPS,        "+COPS",        UG96_COPS_TIMEOUT,     fCmdBuild_COPS,       fRspAnalyze_COPS},
  {_AT_CNUM,        "+CNUM",        UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_CNUM},
  {_AT_CGATT,       "+CGATT",       UG96_CGATT_TIMEOUT,    fCmdBuild_CGATT,      fRspAnalyze_CGATT},
  {_AT_CGPADDR,     "+CGPADDR",     UG96_DEFAULT_TIMEOUT,  fCmdBuild_CGPADDR,    fRspAnalyze_CGPADDR},
  {_AT_CREG,        "+CREG",        UG96_DEFAULT_TIMEOUT,  fCmdBuild_CREG,       fRspAnalyze_CREG},
  {_AT_CGREG,       "+CGREG",       UG96_DEFAULT_TIMEOUT,  fCmdBuild_CGREG,      fRspAnalyze_CGREG},
  {_AT_CGEREP,      "+CGEREP",      UG96_DEFAULT_TIMEOUT,  fCmdBuild_CGEREP,     fRspAnalyze_None},
  {_AT_CGEV,        "+CGEV",        UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_CGEV},
  {_AT_CSQ,         "+CSQ",         UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_CSQ},
  {_AT_CGDCONT,     "+CGDCONT",     UG96_DEFAULT_TIMEOUT,  fCmdBuild_CGDCONT,    fRspAnalyze_None},
  {_AT_CGACT,       "+CGACT",       UG96_CGACT_TIMEOUT,    fCmdBuild_CGACT,      fRspAnalyze_None},
  {_AT_CGDATA,      "+CGDATA",      UG96_DEFAULT_TIMEOUT,  fCmdBuild_CGDATA,     fRspAnalyze_None},
  {_ATD,            "D",            UG96_DEFAULT_TIMEOUT,  fCmdBuild_ATD_UG96,   fRspAnalyze_None},
  {_ATE,            "E",            UG96_DEFAULT_TIMEOUT,  fCmdBuild_ATE,        fRspAnalyze_None},
  {_ATH,            "H",            UG96_ATH_TIMEOUT,      fCmdBuild_NoParams,   fRspAnalyze_None},
  {_ATO,            "O",            UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_None},
  {_ATV,            "V",            UG96_DEFAULT_TIMEOUT,  fCmdBuild_ATV,        fRspAnalyze_None},
  {_ATX,            "X",            UG96_DEFAULT_TIMEOUT,  fCmdBuild_ATX,        fRspAnalyze_None},
  {_AT_ESC_CMD,     "+++",          UG96_ESCAPE_TIMEOUT,   fCmdBuild_ESCAPE_CMD, fRspAnalyze_None},
  {_AT_IPR,         "+IPR",         UG96_DEFAULT_TIMEOUT,  fCmdBuild_IPR,        fRspAnalyze_IPR},
  {_AT_IFC,         "+IFC",         UG96_DEFAULT_TIMEOUT,  fCmdBuild_IFC,        fRspAnalyze_None},
  {_AT_AND_W,       "&W",           UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_None},

  /* MODEM SPECIFIC COMMANDS */
  {_AT_QPOWD,       "+QPOWD",       UG96_DEFAULT_TIMEOUT,  fCmdBuild_QPOWD_UG96, fRspAnalyze_None},
  {_AT_QCFG,        "+QCFG",        UG96_DEFAULT_TIMEOUT,  fCmdBuild_QCFG_UG96,  fRspAnalyze_QCFG_UG96},
  {_AT_QUSIM,       "+QUSIM",       UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_QUSIM_UG96},
  {_AT_QIND,        "+QIND",        UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_QIND_UG96},
  {_AT_QIACT,       "+QIACT",       UG96_QIACT_TIMEOUT,    fCmdBuild_QIACT_UG96,   fRspAnalyze_QIACT_UG96},
  {_AT_QICSGP,      "+QICSGP",      UG96_DEFAULT_TIMEOUT,  fCmdBuild_QICSGP_UG96,   fRspAnalyze_None},
  {_AT_QIOPEN,      "+QIOPEN",      UG96_QIOPEN_TIMEOUT,   fCmdBuild_QIOPEN_UG96, fRspAnalyze_QIOPEN_UG96},
  {_AT_QICLOSE,     "+QICLOSE",     UG96_QICLOSE_TIMEOUT,  fCmdBuild_QICLOSE_UG96, fRspAnalyze_None},
  {_AT_QISEND,      "+QISEND",      UG96_DEFAULT_TIMEOUT,  fCmdBuild_QISEND_UG96, fRspAnalyze_None},
  {_AT_QISEND_WRITE_DATA,  "",      UG96_DEFAULT_TIMEOUT,  fCmdBuild_QISEND_WRITE_DATA_UG96, fRspAnalyze_None},
  {_AT_QIRD,        "+QIRD",        UG96_DEFAULT_TIMEOUT,  fCmdBuild_QIRD_UG96, fRspAnalyze_QIRD_UG96},
  {_AT_QISTATE,     "+QISTATE",     UG96_DEFAULT_TIMEOUT,  fCmdBuild_QISTATE_UG96, fRspAnalyze_QISTATE_UG96},
  {_AT_QIURC,       "+QIURC",       UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams, fRspAnalyze_QIURC_UG96},
  {_AT_SOCKET_PROMPT, "> ",         UG96_SOCKET_PROMPT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_None},
  {_AT_SEND_OK,      "SEND OK",     UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_None},
  {_AT_SEND_FAIL,    "SEND FAIL",   UG96_DEFAULT_TIMEOUT,  fCmdBuild_NoParams,   fRspAnalyze_None},
  {_AT_QIDNSCFG,     "+QIDNSCFG",   UG96_DEFAULT_TIMEOUT,  fCmdBuild_QIDNSCFG_UG96, fRspAnalyze_None},
  {_AT_QIDNSGIP,     "+QIDNSGIP",   UG96_QIDNSGIP_TIMEOUT, fCmdBuild_QIDNSGIP_UG96, fRspAnalyze_None},
  {_AT_QPING,        "+QPING",      UG96_QPING_TIMEOUT,    fCmdBuild_QPING_UG96,    fRspAnalyze_QPING_UG96},

  /* MODEM SPECIFIC EVENTS */
  {_AT_WAIT_EVENT,     "",          UG96_DEFAULT_TIMEOUT,        fCmdBuild_NoParams,   fRspAnalyze_None},
  {_AT_BOOT_EVENT,     "",          UG96_RDY_TIMEOUT,            fCmdBuild_NoParams,   fRspAnalyze_None},
  {_AT_RDY_EVENT,      "RDY",       UG96_RDY_TIMEOUT,            fCmdBuild_NoParams,   fRspAnalyze_None},
  /* {_AT_SIMREADY_EVENT, "",          UG96_SIMREADY_TIMEOUT,       fCmdBuild_NoParams,   fRspAnalyze_None}, */
};
...
at_status_t ATCustom_UG96_getCmd(atparser_context_t *p_atp_ctxt, uint32_t *p_ATcmdTimeout)
{
  ...
  */
  ...
  if (curSID == SID_CS_CHECK_CNX)
  {
    ...
    {
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_EXECUTION_CMD, _AT, FINAL_CMD);
    }
    else
    {
      /* error, invalid step */
  ...
  else if ((curSID == SID_CS_POWER_ON) || (curSID == SID_CS_RESET))
  {
    ...
    else
    {
      ...
      */
      else if ((p_atp_ctxt->step >= 1U) && (p_atp_ctxt->step <= at_max_retries))
      {
        if (UG96_ctxt.persist.modem_at_ready == AT_TRUE)
        {
        ...
        else if (ug96_boot_synchro == AT_FALSE)
        {
          PrintDBG("test connection [try number %d] ", p_atp_ctxt->step)
          /* check modem connection */
          atcm_program_AT_CMD_ANSWER_OPTIONAL(&UG96_ctxt, p_atp_ctxt, ATTYPE_EXECUTION_CMD, _AT, INTERMEDIATE_CMD);
        }
        else
        {
          PrintDBG("modem synchro established, proceed to normal power sequence")
          /* need to set IPR cmd and save */
          ug96_change_ipr_baud_rate = AT_TRUE;

          /* go to next step: jump to POWER ON sequence step */
          p_atp_ctxt->step = start_sequence_step;
        }
      }
      else if (p_atp_ctxt->step == at_max_retries + 1U)
      {
      ...
      {
        atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_EXECUTION_CMD, _AT, INTERMEDIATE_CMD);
      }
      else if (p_atp_ctxt->step == start_sequence_step + 1U)
      {
        /* disable echo */
        UG96_ctxt.CMD_ctxt.command_echo = AT_FALSE;
        atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_EXECUTION_CMD, _ATE, INTERMEDIATE_CMD);
      }
      else if (p_atp_ctxt->step == start_sequence_step + 2U)
      {
        /* request detailled error report */
        atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_CMEE, INTERMEDIATE_CMD);
      }
      else if (p_atp_ctxt->step == start_sequence_step + 3U)
      {
        /* enable full response format */
        UG96_ctxt.CMD_ctxt.dce_full_resp_format = AT_TRUE;
        atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_EXECUTION_CMD, _ATV, INTERMEDIATE_CMD);
      }
      else if (p_atp_ctxt->step == start_sequence_step + 4U)
      {
        /* set flow control */
        atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_IFC, INTERMEDIATE_CMD);
      }
      else if (p_atp_ctxt->step == start_sequence_step + 5U)
      {
        /* Read baud rate settings */
        atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_READ_CMD, _AT_IPR, INTERMEDIATE_CMD);
      }
      else if (p_atp_ctxt->step == start_sequence_step + 6U)
      {
        /* check URC state */
        UG96_QCFG_received_param_name = _QCFG_unknown;
        UG96_QCFG_received_param_value = _QCFG_unknown;
        UG96_QCFG_command_param = _QCFG_stateurc_check;
        atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_QCFG, INTERMEDIATE_CMD);
      }
      else if (p_atp_ctxt->step == start_sequence_step + 7U)
      {
        if ((UG96_QCFG_received_param_name == _QCFG_stateurc_check) &&
            (UG96_QCFG_received_param_value == _QCFG_stateurc_disable))
        {
          /* enable URC state */
          UG96_QCFG_received_param_name = _QCFG_unknown;
          UG96_QCFG_received_param_value = _QCFG_unknown;
          UG96_QCFG_command_param = _QCFG_stateurc_enable;
          atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_QCFG, INTERMEDIATE_CMD);
        }
        else
        {
      ...
      {
        if (ug96_change_ipr_baud_rate == AT_TRUE)
        {
          /* set requested baud rate */
          UG96_ctxt.CMD_ctxt.baud_rate = MODEM_UART_BAUDRATE;
          atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_IPR, INTERMEDIATE_CMD);
        }
        else
        {
          /* finished */
      ...
      else if (p_atp_ctxt->step == start_sequence_step + 10U)
      {
        ...
        atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_EXECUTION_CMD, _AT_AND_W, FINAL_CMD);
      }
      else if (p_atp_ctxt->step > start_sequence_step + 11U)
      {
        /* error, invalid step */
        retval = ATSTATUS_ERROR;
      }
  ...
  else if (curSID == SID_CS_POWER_OFF)
  {
    if (p_atp_ctxt->step == 0U)
    {
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_QPOWD, FINAL_CMD);
    }
    else
    {
      /* error, invalid step */
  ...
  {
#if defined(UG96_OPTION_CHECK_CPIN)
    if (p_atp_ctxt->step == 0U)
    {
      /* check is CPIN is requested */
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_READ_CMD, _AT_CPIN, INTERMEDIATE_CMD);
    }
    else if (p_atp_ctxt->step == 1U)
    {
      if (UG96_ctxt.persist.sim_pin_code_ready == AT_FALSE)
      {
        if (strlen((const char *)&UG96_ctxt.SID_ctxt.modem_init.pincode.pincode) != 0U)
        {
          /* send PIN value */
          PrintINFO("CPIN required, we send user value to modem")
          atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_CPIN, INTERMEDIATE_CMD);
    ...
    else if (p_atp_ctxt->step == 2U)
    {
      ...
      if (ug96_sim_card_ready == AT_TRUE)
      {
        PrintINFO("Modem SIM 'PB DONE' indication already received, continue sequence...")
        ug96_sim_card_ready = AT_FALSE;
        /* go to next step */
        atcm_program_SKIP_CMD(p_atp_ctxt);
      }
    ...
    {
      /* now send CFUN */
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_CFUN, INTERMEDIATE_CMD);
    }
    else if (p_atp_ctxt->step == 4U)
    {
      /* check PDP context parameters */
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_READ_CMD, _AT_CGDCONT, FINAL_CMD);
    }
    else
    {
      /* error, invalid step */
    ...
    if (p_atp_ctxt->step == 0U)
    {
      switch (UG96_ctxt.SID_ctxt.device_info->field_requested)
      {
        case CS_DIF_MANUF_NAME_PRESENT:
          atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_EXECUTION_CMD, _AT_CGMI, FINAL_CMD);
          break;

        case CS_DIF_MODEL_PRESENT:
          atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_EXECUTION_CMD, _AT_CGMM, FINAL_CMD);
          break;

        case CS_DIF_REV_PRESENT:
          atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_EXECUTION_CMD, _AT_CGMR, FINAL_CMD);
          break;

        case CS_DIF_SN_PRESENT:
          atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_EXECUTION_CMD, _AT_CGSN, FINAL_CMD);
          break;

        case CS_DIF_IMEI_PRESENT:
          atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_EXECUTION_CMD, _AT_GSN, FINAL_CMD);
          break;

        case CS_DIF_IMSI_PRESENT:
          atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_EXECUTION_CMD, _AT_CIMI, FINAL_CMD);
          break;
  ...
  else if (curSID == SID_CS_GET_SIGNAL_QUALITY)
  {
    if (p_atp_ctxt->step == 0U)
    {
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_EXECUTION_CMD, _AT_CSQ, FINAL_CMD);
    }
  }
  else if (curSID == SID_CS_GET_ATTACHSTATUS)
  {
    if (p_atp_ctxt->step == 0U)
    {
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_READ_CMD, _AT_CGATT, FINAL_CMD);
    }
    else
    {
      /* error, invalid step */
  ...
  else if (curSID == SID_CS_REGISTER_NET)
  {
    if (p_atp_ctxt->step == 0U)
    {
      ...
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_READ_CMD, _AT_COPS, INTERMEDIATE_CMD);
    }
    else if (p_atp_ctxt->step == 1U)
    {
      /* check if actual registration status is the expected one */
      CS_OperatorSelector_t *operatorSelect = &(UG96_ctxt.SID_ctxt.write_operator_infos);
      if (UG96_ctxt.SID_ctxt.read_operator_infos.mode != operatorSelect->mode)
      {
        /* write registration status */
        atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_COPS, INTERMEDIATE_CMD);
      }
      else
      {
        /* skip this step */
    ...
    {
      /* read registration status */
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_READ_CMD, _AT_CREG, INTERMEDIATE_CMD);
    }
    else if (p_atp_ctxt->step == 3U)
    {
      /* read registration status */
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_READ_CMD, _AT_CGREG, FINAL_CMD);
    }
    else
    {
      /* error, invalid step */
  ...
  else if (curSID == SID_CS_GET_NETSTATUS)
  {
    ...
    {
      /* read registration status */
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_READ_CMD, _AT_CGREG, INTERMEDIATE_CMD);
    }
    else if (p_atp_ctxt->step == 2U)
    {
      /* read registration status */
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_READ_CMD, _AT_COPS, FINAL_CMD);
    }
    else
    {
      /* error, invalid step */
  ...
  else if (curSID == SID_CS_SUSBCRIBE_NET_EVENT)
  {
    if (p_atp_ctxt->step == 0U)
    {
      ...
      {
        atcm_subscribe_net_event(&UG96_ctxt, p_atp_ctxt);
      }
  ...
  else if (curSID == SID_CS_UNSUSBCRIBE_NET_EVENT)
  {
    if (p_atp_ctxt->step == 0U)
    {
      ...
      if ((urcEvent == CS_URCEVENT_GPRS_NETWORK_REG_STAT) || (urcEvent == CS_URCEVENT_GPRS_LOCATION_INFO) ||
          (urcEvent == CS_URCEVENT_CS_NETWORK_REG_STAT) || (urcEvent == CS_URCEVENT_CS_LOCATION_INFO))
      {
        atcm_unsubscribe_net_event(&UG96_ctxt, p_atp_ctxt);
      }
      else if (urcEvent == CS_URCEVENT_SIGNAL_QUALITY)
      {
        /* no command to monitor signal quality with URC in UG96 */
  ...
  else if (curSID == SID_CS_REGISTER_PDN_EVENT)
  {
    if (p_atp_ctxt->step == 0U)
    {
      if (UG96_ctxt.persist.urc_subscript_pdn_event == CELLULAR_FALSE)
      {
        ...
        /* request PDN events */
        atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_CGEREP, FINAL_CMD);
      }
      else
      {
        atcm_program_NO_MORE_CMD(p_atp_ctxt);
  ...
  else if (curSID == SID_ATTACH_PS_DOMAIN)
  {
    if (p_atp_ctxt->step == 0U)
    {
      ...
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_CGATT, FINAL_CMD);
    }
    else
    {
      /* error, invalid step */
  ...
  else if (curSID == SID_CS_ACTIVATE_PDN)
  {
    ...
    {
      /* ckeck PDN state */
      ug96_pdn_already_active = AT_FALSE;
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_READ_CMD, _AT_QIACT, INTERMEDIATE_CMD);
    }
    else if (p_atp_ctxt->step == 1U)
    {
      /* PDN activation */
      if (ug96_pdn_already_active == AT_TRUE)
      {
      ...
      else
      {
        ...
        atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_QIACT, INTERMEDIATE_CMD);
      }
    }
    else if (p_atp_ctxt->step == 2U)
    {
      /* ckeck PDN state */
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_READ_CMD, _AT_QIACT, FINAL_CMD);
    }
    else
    {
      /* error, invalid step */
    ...
    {
      /* PDN activation */
      UG96_ctxt.CMD_ctxt.pdn_state = AT_TRUE;
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_CGACT, INTERMEDIATE_CMD);
    }
    else if (p_atp_ctxt->step == 1U)
    {
      /* get IP address */
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_CGPADDR, INTERMEDIATE_CMD);
    }
    else if (p_atp_ctxt->step == 2U)
    {
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_CGDATA, FINAL_CMD);
    }
    else
    {
      /* error, invalid step */
  ...
  else if (curSID == SID_CS_DEFINE_PDN)
  {
    ...
    if (p_atp_ctxt->step == 0U)
    {
      ug96_QICGSP_config_command = AT_TRUE;
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_QICSGP, INTERMEDIATE_CMD);
    }
    else if (p_atp_ctxt->step == 1U)
    {
      ug96_QICGSP_config_command = AT_FALSE;
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_QICSGP, FINAL_CMD);
    }
    else
    {
      /* error, invalid step */
    ...
    if (p_atp_ctxt->step == 0U)
    {
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_CGDCONT, FINAL_CMD);
    }
    else
    {
      /* error, invalid step */
...
#else
      /* DATA MODE*/
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_CGPADDR, FINAL_CMD);
#endif /* USE_SOCKETS_TYPE */
    }
    else
    {
  ...
  else if (curSID == SID_CS_DIAL_COMMAND)
  {
    ...
    if (p_atp_ctxt->step == 0U)
    {
      ...
      ug96_current_qiopen_socket_connected = 0U;
      socket_handle_t sockHandle = UG96_ctxt.socket_ctxt.socket_info->socket_handle;
      atcm_socket_reserve_modem_cid(&UG96_ctxt, sockHandle);
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_QIOPEN, INTERMEDIATE_CMD);
    ...
    {
      if (ug96_current_qiopen_socket_connected == 0U)
      {
      ...
      {
        /* socket opened */
        ug96_waiting_qiopen = AT_FALSE;
        /* socket is connected */
        atcm_socket_set_connected(&UG96_ctxt, UG96_ctxt.socket_ctxt.socket_info->socket_handle);
        atcm_program_NO_MORE_CMD(p_atp_ctxt);
      }
    }
    else  if (p_atp_ctxt->step == 2U)
    {
      if (ug96_current_qiopen_socket_connected == 0U)
      {
        ...
        */
        ug96_waiting_qiopen = AT_FALSE;
        atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_QICLOSE, INTERMEDIATE_CMD);
      }
      else
      {
        /* socket opened */
    ...
    else  if (p_atp_ctxt->step == 3U)
    {
      ...
      */
      ...
      atcm_socket_release_modem_cid(&UG96_ctxt, UG96_ctxt.socket_ctxt.socket_info->socket_handle);
      atcm_program_NO_MORE_CMD(p_atp_ctxt);
      retval = ATSTATUS_ERROR;
    }
    else
  ...
  else if (curSID == SID_CS_SEND_DATA)
  {
    if (p_atp_ctxt->step == 0U)
    {
      ...
      {
        UG96_ctxt.socket_ctxt.socket_send_state = SocketSendState_WaitingPrompt1st_greaterthan;
        atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_QISEND, INTERMEDIATE_CMD);
      }
    }
    else if (p_atp_ctxt->step == 1U)
    {
    ...
    else if (p_atp_ctxt->step == 2U)
    {
      ...
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_RAW_CMD, _AT_QISEND_WRITE_DATA, FINAL_CMD);
  ...
  else if (curSID == SID_CS_RECEIVE_DATA)
  {
    if (p_atp_ctxt->step == 0U)
    {
      ...
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_QIRD, INTERMEDIATE_CMD);
    }
    else if (p_atp_ctxt->step == 1U)
    {
      ...
      if (UG96_ctxt.socket_ctxt.socket_rx_expected_buf_size != 0U)
      {
        ...
        */
        ...
        atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_QIRD, FINAL_CMD);
      }
      else
      {
        /* no datas to receive */
  ...
  else if (curSID == SID_CS_DATA_SUSPEND)
  {
    ...
    else if (p_atp_ctxt->step == 1U)
    {
      ...
      */
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_RAW_CMD, _AT_ESC_CMD, FINAL_CMD);
      reinitSyntaxAutomaton_ug96();
    }
    else
    {
  ...
  else if (curSID == SID_CS_SOCKET_CNX_STATUS)
  {
    if (p_atp_ctxt->step == 0U)
    {
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_QISTATE, FINAL_CMD);
    }
    else
    {
      /* error, invalid step */
  ...
  else if (curSID == SID_CS_DATA_RESUME)
  {
    if (p_atp_ctxt->step == 0U)
    {
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_EXECUTION_CMD, _ATO, FINAL_CMD);
    }
    else
    {
      /* error, invalid step */
  ...
  else if (curSID == SID_CS_DNS_REQ)
  {
    if (p_atp_ctxt->step == 0U)
    {
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_QIDNSCFG, INTERMEDIATE_CMD);
    }
    else if (p_atp_ctxt->step == 1U)
    {
      /* intialize +QIURC "dnsgip" parameters */
      init_ug96_qiurc_dnsgip();
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_QIDNSGIP, INTERMEDIATE_CMD);
    }
    else if (p_atp_ctxt->step == 2U)
    {
      /* do we have received a valid DNS response ? */
      if ((ug96_qiurc_dnsgip.finished == AT_TRUE) && (ug96_qiurc_dnsgip.error == 0U))
      {
        /* yes */
        atcm_program_NO_MORE_CMD(p_atp_ctxt);
      }
  ...
  else if (curSID == SID_CS_PING_IP_ADDRESS)
  {
    if (p_atp_ctxt->step == 0U)
    {
      atcm_program_AT_CMD(&UG96_ctxt, p_atp_ctxt, ATTYPE_WRITE_CMD, _AT_QPING, FINAL_CMD);
    }
    else
    {
      /* error, invalid step */
                                         ...
                                         at_element_info_t *element_infos)
{
  ...
  do
  {
    switch (p_msg_in->buffer[*p_parseIndex])
    {
      ...
      /* ----- test separators ----- */
      case ' ':
        if (p_atp_ctxt->current_atcmd.id == _AT_CGDATA)
        {
  ...
  */
  switch (p_atp_ctxt->current_SID)
  {
    case SID_CS_DNS_REQ:
      ...
      if (DATAPACK_writeStruct(p_rsp_buf, CSMT_DNS_REQ, sizeof(ug96_qiurc_dnsgip.hostIPaddr), (void *)ug96_qiurc_dnsgip.hostIPaddr) != DATAPACK_OK)
      {
        retval = ATSTATUS_ERROR;
      }
      break;
...
static at_status_t fCmdBuild_QCFG_UG96(atparser_context_t *p_atp_ctxt, atcustom_modem_context_t *p_modem_ctxt)
{
  ...
  if (p_atp_ctxt->current_atcmd.type == ATTYPE_WRITE_CMD)
  {
    ...
    switch (UG96_QCFG_command_param)
    {
      case _QCFG_stateurc_check:
        sprintf((char *)p_atp_ctxt->current_atcmd.params, "\"stateurc/enable\"");
        break;

      case _QCFG_stateurc_enable:
        PrintDBG("Request to enable urcstate")
        sprintf((char *)p_atp_ctxt->current_atcmd.params, "\"stateurc/enable\",1");
        break;

      case _QCFG_stateurc_disable:
        PrintDBG("Request to disable urcstate")
        sprintf((char *)p_atp_ctxt->current_atcmd.params, "\"stateurc/enable\",0");
        break;
...
static at_status_t fCmdBuild_QICSGP_UG96(atparser_context_t *p_atp_ctxt, atcustom_modem_context_t *p_modem_ctxt)
{
  ...
  if (p_atp_ctxt->current_atcmd.type == ATTYPE_WRITE_CMD)
  {
    ...
    */
    ...
    if (ug96_QICGSP_config_command == AT_TRUE)
    {
      ...
      */
      ...
      if (p_atp_ctxt->current_SID == SID_CS_DIAL_COMMAND)
      {
        ...
        sprintf((char *)p_atp_ctxt->current_atcmd.params, "%d,%ld,\"%s\",\"%s\",%d,%d,%d",
                ...
                ug96_array_QIOPEN_service_type[_service_type_index],
...
static at_status_t fCmdBuild_QIRD_UG96(atparser_context_t *p_atp_ctxt, atcustom_modem_context_t *p_modem_ctxt)
{
  ...
  if (p_atp_ctxt->current_atcmd.type == ATTYPE_WRITE_CMD)
  {
    if (UG96_ctxt.socket_ctxt.socket_receive_state == SocketRcvState_RequestSize)
    {
    ...
    else if (UG96_ctxt.socket_ctxt.socket_receive_state == SocketRcvState_RequestData_Header)
    {
                                             ...
                                             IPC_RxMessage_t *p_msg_in, at_element_info_t *element_infos)
{
  ...
  */
  ...
  if (element_infos->param_rank == 2U)
  {
    ...
    if ((char *) strstr((const char *)&line[0], "SMS DONE") != NULL)
    {
      PrintDBG("received SMS DONE")
    }
    else if ((char *) strstr((const char *)&line[0], "PB DONE") != NULL)
    {
      PrintDBG("received PB DONE")
      if ((p_atp_ctxt->current_SID == SID_CS_POWER_ON) ||
          (p_atp_ctxt->current_SID == SID_CS_RESET) ||
          (p_atp_ctxt->current_SID == SID_CS_INIT_MODEM))
      {
        /* if we were waiting for this event, we can continue the sequence */
                                             ...
                                             IPC_RxMessage_t *p_msg_in, at_element_info_t *element_infos)
{
  ...
  if (p_atp_ctxt->current_atcmd.id == _AT_QCFG)
  {
    START_PARAM_LOOP()
    if (element_infos->param_rank == 2U)
    {
      ...
      if (UG96_QCFG_command_param == _QCFG_stateurc_check)
      {
        PrintDBG("+QCFG staturc settings received")
        UG96_QCFG_received_param_name = _QCFG_stateurc_check;
      }
    }
    if (element_infos->param_rank == 3U)
    {
      ...
      /* */
      switch (UG96_QCFG_received_param_name)
      {
        case _QCFG_stateurc_check:
        {
          if (param == 0U)
          ...
          else if (param == 1U)
          {
            ...
            UG96_QCFG_received_param_value = _QCFG_stateurc_enable;
          }
          else { /* param ignored */ }
          break;
        }
...
#if (USE_SOCKETS_TYPE == USE_SOCKETS_MODEM)
          ug96_pdn_already_active = AT_TRUE;
#endif
        }
      }
    }
                                               ...
                                               IPC_RxMessage_t *p_msg_in, at_element_info_t *element_infos)
{
  ...
  if (ug96_waiting_qiopen == AT_TRUE)
  {
    START_PARAM_LOOP()
    if (element_infos->param_rank == 2U)
    {
    ...
    else if (element_infos->param_rank == 3U)
    {
      ...
      *  and check if err=0
      */
      if ((ug96_current_qiopen_connectId == atcm_socket_get_modem_cid(p_modem_ctxt, p_modem_ctxt->socket_ctxt.socket_info->socket_handle)) &&
          (err_value == 0U))
      {
        PrintINFO("socket (connectId=%ld) opened", ug96_current_qiopen_connectId)
        ug96_current_qiopen_socket_connected = 1U;
        ug96_waiting_qiopen = AT_FALSE;
        retval = ATACTION_RSP_FRC_END;
      }
      else
                                              ...
                                              IPC_RxMessage_t *p_msg_in, at_element_info_t *element_infos)
{
  ...
  ATCustom_UG96_QIURC_function_t ug96_current_qiurc_ind = _QIURC_unknown;
  ...
  if (element_infos->param_rank == 2U)
  {
    ...
    ug96_current_qiurc_ind = _QIURC_unknown;
  ...
  else if (element_infos->param_rank == 3U)
  {
    ...
    switch (ug96_current_qiurc_ind)
    {
      ...
      case _QIURC_dnsgip:
        /* <err> or <hostIPaddr>]> */
        if (ug96_qiurc_dnsgip.wait_header == AT_TRUE)
        {
          /* <err> expected */
          ug96_qiurc_dnsgip.error = ATutil_convertStringToInt(&p_msg_in->buffer[element_infos->str_start_idx], element_infos->str_size);
          PrintDBG("+QIURC dnsgip with error=%ld", ug96_qiurc_dnsgip.error)
          if (ug96_qiurc_dnsgip.error != 0U)
          {
            /* Error when trying to get host address */
            ug96_qiurc_dnsgip.finished = AT_TRUE;
            retval = ATACTION_RSP_ERROR;
          }
        }
        else
        {
          ...
          */
          memcpy((void *)ug96_qiurc_dnsgip.hostIPaddr,
                 (void *) & (p_msg_in->buffer[element_infos->str_start_idx]),
                 (size_t) element_infos->str_size);
          PrintDBG("+QIURC dnsgip Host address #%ld =%s", ug96_qiurc_dnsgip.ip_count, ug96_qiurc_dnsgip.hostIPaddr)
          ug96_qiurc_dnsgip.ip_count--;
          if (ug96_qiurc_dnsgip.ip_count == 0U)
          {
  ...
  else if (element_infos->param_rank == 4U)
  {
    switch (ug96_current_qiurc_ind)
    {
      ...
      case _QIURC_dnsgip:
        ...
        if (ug96_qiurc_dnsgip.wait_header == AT_TRUE)
        {
          /* <ug96_qiurc_dnsgip.ip_count> expected */
          ug96_qiurc_dnsgip.ip_count = ATutil_convertStringToInt(&p_msg_in->buffer[element_infos->str_start_idx], element_infos->str_size);
          PrintDBG("+QIURC dnsgip IP count=%ld", ug96_qiurc_dnsgip.ip_count)
          if (ug96_qiurc_dnsgip.ip_count == 0U)
          {
  ...
  else if (element_infos->param_rank == 5U)
  {
    ...
    switch (ug96_current_qiurc_ind)
    {
      ...
      case _QIURC_dnsgip:
        ...
        if (ug96_qiurc_dnsgip.wait_header == AT_TRUE)
        {
          /* <ug96_qiurc_dnsgip.ttl> expected */
          ug96_qiurc_dnsgip.ttl = ATutil_convertStringToInt(&p_msg_in->buffer[element_infos->str_start_idx], element_infos->str_size);
          PrintDBG("+QIURC dnsgip time-to-live=%ld", ug96_qiurc_dnsgip.ttl)
          /* no error, now waiting for URC with IP address */
          ug96_qiurc_dnsgip.wait_header = AT_FALSE;
        }
        break;
...
static void reset_variables_ug96(void)
{
  ...
  ug96_change_ipr_baud_rate = AT_FALSE;
  ug96_boot_synchro = AT_FALSE;
  ug96_sim_card_ready = AT_FALSE;
}

static void init_ug96_qiurc_dnsgip(void)
{
  ug96_qiurc_dnsgip.finished = AT_FALSE;
  ug96_qiurc_dnsgip.wait_header = AT_TRUE;
  ug96_qiurc_dnsgip.error = 0U;
  ug96_qiurc_dnsgip.ip_count = 0U;
  ug96_qiurc_dnsgip.ttl = 0U;
  memset((void *)ug96_qiurc_dnsgip.hostIPaddr, 0, MAX_SIZE_IPADDR);
}
