...
/* Includes ------------------------------------------------------------------*/
/* Exported constants --------------------------------------------------------*/
#define HTTPCLIENT_CONFIG_UNITARY_TEST (1) /* 0: unitary tests not activated,
...
#define HTTP_SERVER_TEST_NAME  ((uint8_t *)"www.lorytech.com")
#define HTTP_SERVER_TEST_IP    ((uint32_t)0x0102A8C0U)   /* 192.168.2.1 */
#define HTTP_SERVER_TEST_PORT  ((uint16_t)7903U)
#endif
